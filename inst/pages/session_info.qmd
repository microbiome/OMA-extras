...
👉 [ghcr.io/microbiome/oma-extras](https://ghcr.io/microbiome/oma-extras) 🐳
...
docker run -it ghcr.io/microbiome/oma-extras:devel R
```
...
docker run \
    ...
    -e PASSWORD=OMA \
    -p 8787:8787 \
    ghcr.io/microbiome/oma-extras:devel
```
